...
function setDisplay(id, show) {
    ...
    if (el) el.style.display = show ? 'block' : 'none'; // or appropriate display type
}

// Helper to show/hide elements using bootstrap d-none/d-block if needed, or style.display
